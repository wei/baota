var lan = {
	...
	"firewall":{
		...
		"ip":"欲屏蔽的IP地址",
		"drop":"屏蔽",
		"ip_ps":"说明: 支持放行IP段，如: 192.168.0.0/24",
	...
	"bt":{
		...
		"install_src":"编译安装",
		"install_src_title":"安装时间长（30分钟到3小时），适全生产环境",
		"install_key":"一键安装",
	...
	"site":{
		...
		"ssl_help_3":"如需使用其他SSL,请切换其他证书后粘贴您的KEY以及CRT内容，然后保存即可。",
		"ssl_key":"密钥(KEY)",
		"ssl_crt":"证书(CRT/PEM)",
		"ssl_close":"关闭SSL",
		...
		"bt_ssl_help_10":"粘贴您的KEY以及CRT内容，然后保存即可<a href='http://www.bt.cn/bbs/thread-704-1-1.html' class='btlink' target='_blank'>[帮助]</a>。",
		"phone_input":"请输入手机号码",
