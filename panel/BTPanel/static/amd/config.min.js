									...
									return __generator(this, function (_a) {
										switch (_a.label) {
											...
											case 2:
												...
												close() &&
												this.$refreshBrowser(location.href.replace(/^http:/, 'https:'), 3000);
												return [2];
										}
									});
								}); },
												...
												switch (_a.label) {
													...
													case 1:
														...
														document
															...
															.setAttribute('data-clipboard-text', root_password_1);
												...
												return __generator(this, function (_b) {
													switch (_b.label) {
														...
														case 2:
															rdata = _b.sent();
															rdata.status &&
															that.$refreshBrowser(location.href.replace(/^http:/, 'https:'));
															return [3, 4];
														case 3:
										...
										switch (_b.label) {
											...
											case 2:
												...
												(pawExpireValue.value =
													expire > 0
														? "".concat(this.$formatTime(expire_time), " ( \u5269\u4F59").concat(expire_day, "\u5929\u8FC7\u671F )")
														: "\u672A\u8BBE\u7F6E");
				...
				return __generator(this, function (_b) {
					switch (_b.label) {
						case 0:
							...
							isEmail = channelInfo.mail.data, isDing = channelInfo.dingding.data;
							if ($.isEmptyObject(isEmail) && $.isEmptyObject(isDing))
								return [2, this.$msg({ msg: '请在消息通道中设置【邮箱/钉钉】通道', icon: 2 })];
											...
											return __generator(this, function (_a) {
												switch (_a.label) {
													case 0:
														...
														if (type == 'mail' && $.isEmptyObject(isEmail)) {
															that.prop('checked', !checked);
															return [2, this.$error('未配置消息通道 [邮箱]')];
														}
														if (type == 'dingding' && $.isEmptyObject(isDing)) {
															that.prop('checked', !checked);
							...
							for (key in this.configInfo) {
								if (Object.prototype.hasOwnProperty.call(this.configInfo, key)) {
									...
									if (type === 'checkbox') {
										...
										el.val(pawComplexity.expire > 0
											? "".concat(this.$formatTime(pawComplexity.expire_time), " (\u5269\u4F59").concat(pawComplexity.expire_day, "\u5929\u8FC7\u671F )")
											: "\u672A\u8BBE\u7F6E");
									}
									else {
										el.val(item);
							...
							switch (_c.label) {
								...
								case 4:
									config = {
										...
										msg: checked
											? "".concat(status, " \u79BB\u7EBF\u6A21\u5F0F\u540E\u9762\u677F\u5C06\u505C\u6B62\u8FDE\u63A5\u4E91\u7AEF\uFF0C\u4ECB\u65F6\u8F6F\u4EF6\u5B89\u88C5\u3001\u5378\u8F7D\u3001\u9762\u677F\u66F4\u65B0\u7B49\u529F\u80FD\u5C06\u65E0\u6CD5\u4F7F\u7528\uFF0C\u662F\u5426\u7EE7\u7EED\uFF01")
											: "\u662F\u5426".concat(status, " \u79BB\u7EBF\u6A21\u5F0F\uFF0C\u7EE7\u7EED\u64CD\u4F5C\uFF01"),
								...
								case 10:
									config = {
										...
										msg: !checked
											? "".concat(status, " \u5728\u7EBF\u5BA2\u670D\u540E\uFF0C\u5C06\u4E0D\u5728\u652F\u6301\u5728\u7EBF\u5BA2\u670D\u529F\u80FD\uFF0C\u7EE7\u7EED\u64CD\u4F5C\uFF1F")
											: "".concat(status, " \u5728\u7EBF\u5BA2\u670D\u540E\uFF0C\u53EF\u4EE5\u4F7F\u7528\u5728\u7EBF\u5BA2\u670D\u529F\u80FD\uFF0C\u5411\u5B9D\u5854\u6280\u672F\u4EBA\u5458\u53CD\u9988\u95EE\u9898\uFF0C\u7EE7\u7EED\u64CD\u4F5C"),
										confirm: function () { return __awaiter(_this, void 0, void 0, function () {
											return __generator(this, function (_a) {
												switch (_a.label) {
								...
								case 13:
									config = {
										title: "\u5173\u95ED\u9762\u677FSSL",
										msg: "\u5173\u95ED\u9762\u677FSSL\u8BC1\u4E66".concat(this.configInfo.ssl_verify
											...
											return __generator(this, function (_a) {
												switch (_a.label) {
													...
													case 2:
														rdata = _a.sent();
														rdata.status &&
														this.$refreshBrowser(location.href.replace(/^https:/, 'http:'));
														return [2];
												}
											});
										}); },
								...
								case 29:
									config = {
										...
										msg: "".concat(status).concat(!checked
											? '密码复杂度后，密码登录将不再验证密码复杂度，这将会导致面板安全性下降'
											: '密码复杂度验证后，将会对密码进行复杂度判断，规则：<span style="color:red;">密码必须满足密码长度大于8位且大写字母、小写字母、数字、特殊字符至少3项组合</span>', "\uFF0C\u7EE7\u7EED\u64CD\u4F5C\uFF01"),
										confirm: function () { return __awaiter(_this, void 0, void 0, function () {
											var rdata;
											return __generator(this, function (_a) {
												switch (_a.label) {
