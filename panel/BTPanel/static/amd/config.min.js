...
define(["require", "exports", "./snabbdom", "./public/public"], function (require, exports, snabbdom_1, public_1) {
	...
	var Config = (function (_super) {
		...
		function Config() {
			...
			_this.panelSiteList = [];
			_this.taskTypeList = [
				{ title: '网站证书(SSL)到期', value: 'ssl', model: 'site_push' },
				{ title: '网站到期', value: 'site_endtime', model: 'site_push' },
				{ title: '面板密码有效期', value: 'panel_pwd_endtime', model: 'site_push' },
				{ title: '面板登录告警', value: 'panel_login', model: 'site_push' },
				{ title: 'SSH登录告警', value: 'ssh_login', model: 'site_push' },
				{ title: 'SSH登录失败告警', value: 'ssh_login_error', model: 'site_push' },
				{ title: '服务停止告警', value: 'service_stop', model: 'site_push' },
				{ title: '面板安全告警', value: 'panel_safe_push', model: 'site_push' },
				{ title: '面板更新提醒', value: 'panel_update', model: 'site_push' },
			];
			...
			_this.alertConfigForm = [{
				...
				group: {
					...
					value: '',
					list: [
						{ title: 'nginx服务停止', value: 'nginx' },
						{ title: 'mysql服务停止', value: 'mysql' },
						{ title: 'php-fpm服务停止', value: 'php-fpm' },
						{ title: 'pure-ftpd服务停止', value: 'pure-ftpd' },
						{ title: 'redis服务停止', value: 'redis' },
						{ title: 'memcached服务停止', value: 'memcached' },
						{ title: 'apache服务停止', value: 'apache' },
					],
					change: function (formData, element, that) {
						formData['type'] = 'service_stop';
						var config = _this.switchPushType(that.config.form, formData);
						that.$again_render_form(config);
					}
				}
				...
				group: {
					...
					width: '70px',
					value: 1,
					unit: '次后将不再发送告警信息，如需发送多次请填写2次以上'
				}
			}, {
				label: '告警方式',
				group: []
				...
				group: {
					...
					list: ['面板用户变更、面板日志删除、面板开启开发者、面板开启API']
				}
			}, {
				label: '',
				group: {
								...
								content: {
									...
									template: function () {
										...
										return ((0, snabbdom_1.jsx)("div", { class: this.$class('bt-form pd25') },
											...
											this.$ul({ className: 'explainDescribeList pd15' }, [['必须要用到且了解此功能才决定自己是否要开启!', 'red'], ['面板SSL是自签证书，不被浏览器信任，显示不安全是正常现象'], ['自签证书，请在面板SSL配置中下载并安装根证书'], ['开启后导致面板不能访问，可以点击下面链接了解解决方法']]),
													...
													switch (_b.label) {
														...
														case 3:
															...
															return [4, that.$confirm({
																title: "\u5173\u95ED\u9762\u677FSSL",
																msg: "\u5173\u95ED\u9762\u677FSSL\u8BC1\u4E66".concat(that.configInfo.ssl_verify ? '，<span style="color:red">检测到当前面板已开启访问设备验证，关闭后，访问设备验证将会失效</span>' : '', "\uFF0C\u662F\u5426\u7EE7\u7EED\uFF01"),
															})];
														case 4:
															_b.sent();
															return [4, that.$request('setPanelSsl')];
		...
		Config.prototype.setAlarmView = function () {
			return __awaiter(this, void 0, void 0, function () {
				var config, channelInfo, wx_account, email, feishu, weixin, dingding, sms, isChannel, error_15;
				var _this = this;
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							wx_account = channelInfo.wx_account.data, email = channelInfo.mail.data, feishu = channelInfo.feishu.data, weixin = channelInfo.weixin.data, dingding = channelInfo.dingding.data, sms = channelInfo.sms.data;
							isChannel = !(wx_account && !$.isEmptyObject(wx_account.res) && wx_account.res.is_bound == 1 && wx_account.res.is_subscribe == 1) && !(email && email.receive) && !(feishu && feishu.feishu_url) && !(weixin && weixin.weixin_url) && !(dingding && dingding.dingding_url) && $.isEmptyObject(sms);
							if (isChannel)
								return [2, this.$msg({ msg: '请在[告警通知>告警设置]中配置一个告警模块', icon: 2 })];
							_a.label = 1;
						case 1:
							_a.trys.push([1, 3, , 4]);
							return [4, this.$open({
								...
								success: function () { return __awaiter(_this, void 0, void 0, function () {
									...
									return __generator(this, function (_a) {
										...
										$('.news-channel .bt-form-new').on('change', 'input[type="checkbox"]', function (ev) { return __awaiter(_this, void 0, void 0, function () {
											var $el, checked, type, name_1, res, error_16;
											return __generator(this, function (_a) {
												switch (_a.label) {
													case 0:
														$el = $(ev.currentTarget);
													...
													case 2:
														...
														if (checked) {
															...
															config.login_alarm_info = type;
														}
														else {
															config.login_alarm_info = '';
														}
		...
		Config.prototype.renderAlarmConfig = function () {
			return __awaiter(this, void 0, void 0, function () {
				var _a, alarms, send, html, tits, cKey;
				return __generator(this, function (_b) {
					switch (_b.label) {
						case 0: return [4, Promise.all([
							this.$request(['config/get_msg_push_list'], {
								loading: false,
								msg: false,
							}),
							this.$request(['config/get_login_send'], { loading: false, msg: false }),
						])];
						case 1:
			...
			$('.alertTest').click(function (ev) { return __awaiter(_this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							_type = $(ev.currentTarget).parents('tr').data('name');
							return [4, this.$request(['config/get_msg_fun', '测试发送'], { fun_name: 'push_data', module_name: _type, msg: '测试发送' })];
						case 1:
							_result = _a.sent();
							if (_result['status'])
			...
			$('.uninstall_alert').click(function (ev) { return __awaiter(_this, void 0, void 0, function () {
				...
				return __generator(this, function (_b) {
					switch (_b.label) {
						...
						case 1:
							_b.sent();
							return [4, this.$request(['config/uninstall_msg_module&name=' + _type, '删除' + info[_type].title + '告警模块'])];
						case 2:
							rdata = _b.sent();
							_a = rdata.status;
							if (!_a) return [3, 4];
			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_b) {
					switch (_b.label) {
						case 0: return [4, this.$request('getMessageChannel', { loading: false, msg: false })];
						case 1:
							ChannelMessage = _b.sent(), resetChannelMessage = [], prevArray = [];
				...
				column: [
					{
						...
						template: function (row) {
							...
							switch (row.type) {
								case 'ssl':
									_title = "[".concat(row.project == 'all' ? '全部' : row.project, "]").concat(row.title);
									break;
								default:
									_title = row.title;
									break;
						...
						event: function (row) { return __awaiter(_this, void 0, void 0, function () {
							...
							return __generator(this, function (_a) {
								switch (_a.label) {
									case 0:
										if (row.type == 'ssh_login')
											return [2, layer.msg('不支持暂停SSH登录告警，如需停止请直接删除.', { icon: 0 })];
										param = {}, eData = $.extend(true, row, { status: row.status ? false : true });
										param['name'] = row.module_type;
										param['id'] = row.id;
										param['data'] = JSON.stringify(eData);
										return [4, this.$request(['push/set_push_config', '设置告警任务'], param)];
									case 1:
										rdata = _a.sent();
										if (!rdata.status) return [3, 3];
						...
						template: function (row) {
							switch (row.type) {
								...
								case 'panel_pwd_endtime':
									return "<span>\u5269\u4F59\u65F6\u95F4\u5C0F\u4E8E".concat(row.cycle, "\u5929 ").concat(typeof row.push_count != 'undefined' ? '(如未处理，次日会重新发送1次，持续' + row.push_count + '天)' : '', "</span>");
								case 'ssh_login_error':
									return "<span>".concat(row.cycle, "\u5206\u949F\u5185\u8FDE\u7EED").concat(row.count, "\u6B21\u5931\u8D25\u767B\u5F55\u89E6\u53D1,\u6BCF").concat(row.interval, "\u79D2\u540E\u518D\u6B21\u68C0\u6D4B</span>");
								case 'panel_update':
									return "<span>\u68C0\u6D4B\u5230\u65B0\u7684\u7248\u672C\u65F6\u53D1\u9001\u4E00\u6B21\u901A\u77E5</span>";
								case 'services':
									return "<span>\u670D\u52A1\u505C\u6B62\u65F6\u53D1\u9001\u4E00\u6B21\u901A\u77E5,".concat(row.interval, "\u79D2\u540E\u518D\u6B21\u68C0\u6D4B</span>");
								default:
									return "";
							}
						}
							...
							event: function (row) { return __awaiter(_this, void 0, void 0, function () {
								...
								return __generator(this, function (_a) {
									switch (_a.label) {
										...
										case 1:
											_a.sent();
											return [4, this.$request(['push/del_push_config', '删除告警任务'], { name: row.module_type, id: row.id, })];
										case 2:
											rdata = _a.sent();
				...
				tootls: [{
					...
					config: {
						...
						callback: function (that) {
							bt.confirm({ title: '批量删除任务', msg: '批量删除后将无法恢复，是否继续？', icon: 0 }, function (index) {
								layer.close(index);
								that.start_batch({}, function (list) {
									...
									alertListTabel.$batch_success_table({ title: '批量删除任务', th: '任务标题', html: html });
		...
		Config.prototype.switchPushType = function (config, formData) {
			...
			var _checklist = [], isCheckType = [], siteList = [{ title: '所有网站', value: 'all' }], accountConfigStatus = false;
			;
			if (!formData.type) {
				formData.type = 'ssl';
			...
			this.alertListModule.forEach(function (mod, i) {
				...
				_checklist.push({
					...
					event: function (formData, element, thatE) {
						thatE.config.form[7].group[i].value = !formData[mod.name] ? 0 : 1;
					}
				});
			});
			if (!formData.id) {
				...
				if (formData.type == 'ssl')
					config[1].group.value = formData.project;
			}
			config[1].hide = true;
			config[2].hide = true;
			config[3].hide = true;
			...
			switch (formData.type) {
				case 'ssl':
					config[1].hide = false;
					config[3].hide = false;
					config[3].group.value = 15;
					break;
				case 'site_endtime':
					config[3].hide = false;
					config[3].group.value = 7;
					break;
				case 'panel_pwd_endtime':
					config[3].hide = false;
					config[3].group.value = 15;
				...
				case 'panel_update':
					...
					if (formData.type == 'panel_update') {
						config[0].group.unit = '* 当检测到新的版本时发送一次通知';
					}
					break;
				case 'ssh_login_error':
					config[4].hide = false;
				...
				case 'services':
					config[2].hide = false;
					config[2].group.value = formData.service;
					config[3].hide = true;
					config[5].hide = false;
					config[6].hide = true;
					break;
			}
			config[8].hide = formData.type === 'panel_safe_push' ? false : true;
			config[0].group.value = formData.type;
			config[1].group.list = siteList;
			config[7].group = _checklist;
			return config;
		};
				...
				return __generator(this, function (_a) {
					...
					switch (row.type) {
						case 'ssh_login_error':
							...
							break;
						case 'services':
							_config[0].group.value = 'service_stop';
							_config[2].group.value = row.project;
							break;
					}
					bt_tools.open({
						type: 1,
		...
		Config.prototype.setAlertConfigTask = function (row, close) {
			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							_configD = {}, eData = {}, pushType = this.taskTypeList.find(function (el) { return el.value == row.type; }), otherType = this.disabledOption;
							...
							switch (row.type) {
								...
								case 'panel_pwd_endtime':
									if (row.type == 'ssl')
										eData['project'] = row.site;
									if (row.cycle == '' || row.cycle < 0)
										return [2, this.$msg({ icon: 2, msg: '剩余天数不能小于1。', time: 0, closeBtn: 2 })];
									eData['cycle'] = Number(row.cycle);
									eData['push_count'] = Number(row.push_count);
									break;
								case 'ssh_login_error':
									if (row.where1 == '' || row.where1 <= 0)
										return [2, this.$msg({ icon: 2, msg: '触发时间不能小于1', time: 0, closeBtn: 2 })];
									if (row.count == '' || row.count <= 0)
										return [2, this.$msg({ icon: 2, msg: '触发次数不能小于1', time: 0, closeBtn: 2 })];
									if (row.interval == '' || row.interval <= 0)
										return [2, this.$msg({ icon: 2, msg: '间隔时间不能小于1', time: 0, closeBtn: 2 })];
								...
								case 'services':
									eData['interval'] = Number(row.interval);
									eData['type'] = 'services';
									eData['project'] = row.service;
									eData['cycle'] = 1;
									eData['title'] = $((row.id ? '.panel_alert_task_view ' : '#addAlertTask ') + '.alertTypeBox .bt_select_content').html();
									break;
							}
							isCheck = [];
							...
							if (typeof eData['push_count'] != 'undefined' && (eData['push_count'] <= 0 || eData['push_count'] == '')) {
								this.$msg({ icon: 2, msg: '发送次数不能小于1', time: 0, closeBtn: 2 });
								return [2, false];
							}
							if (!eData['module']) {
								this.$msg({ icon: 2, msg: '请选择一种告警方式。', time: 0, closeBtn: 2 });
								return [2, false];
							}
			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_c) {
					switch (_c.label) {
						...
						case 2:
							_a = _c.sent(), configInfo = _a[0], panelSafe = _a[1], twoStep = _a[2], sslVerify = _a[3], pawComplexity = _a[4], bindUserInfo = _a[5], messageChannelInfo = _a[6], loginAlarmInfo = _a[7], getMenuList = _a[8], getNodeConfig = _a[9];
		...
		Config.prototype.searchSetup = function (search) {
			...
			if (lines.length === 0) {
				$('.panel-search-box').text('很抱歉，没有找到有关"' + search + '"的设置');
			}
			else {
		...
		Config.prototype.openPanelSafeAlertMethodView = function (_status) {
			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0: return [4, this.$request('getPanelSafe', { id: 'panel_safe_push', name: 'site_push' }, { loading: false, msg: false })];
						case 1:
							safeInfo = _a.sent();
			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					...
					$('input[type="checkbox"]').on('change', function (ev) { return __awaiter(_this, void 0, void 0, function () {
						var el, _a, name, checked, status, config, _b, data, res, _c, rdata, error_19;
						var _this = this;
						return __generator(this, function (_d) {
							switch (_d.label) {
								...
								case 7:
									...
									return [4, this.$request('setPanelSafe', { name: 'site_push', id: 'panel_safe_push', data: data })];
								case 8:
									res = _d.sent();
									res.status;
									_d.label = 9;
					...
					$('.login-alarm-line').on('click', '.setAlarmMail, .setAlarmMailBtn', function () { $('[data-type=alertConfig]').click(); });
