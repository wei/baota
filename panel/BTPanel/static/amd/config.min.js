			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					...
					$('input[type="checkbox"]').on('change', function (ev) { return __awaiter(_this, void 0, void 0, function () {
						var el, _a, name, checked, status, config, _b, _c, rdata, error_19;
						var _this = this;
							...
							switch (_d.label) {
								...
								case 1:
									...
									switch (_b) {
										...
										case 'debug': return [3, 6];
										case 'api': return [3, 7];
										case 'show_workorder': return [3, 12];
										case 'ssl': return [3, 13];
										case 'basic_auth': return [3, 14];
										case 'check_two_step': return [3, 18];
										case 'ssl_verify': return [3, 23];
										case 'paw_complexity': return [3, 28];
									}
									return [3, 29];
								case 2:
									config = {
								...
								case 6:
									...
									return [3, 29];
								case 7:
									if (!checked) return [3, 9];
									return [4, this.setPanelApiView(checked)];
								case 8:
									_c = _d.sent();
									return [3, 11];
								case 9: return [4, this.$request('setToken', { t_type: 2 })];
								case 10:
									_c = _d.sent();
									_d.label = 11;
								case 11:
								...
								case 17: return [3, 29];
								case 18:
									if (!checked) return [3, 20];
									return [4, this.setGoogleAuthView()];
								case 19:
									_d.sent();
									return [3, 22];
								case 20: return [4, this.$request('setTwoStepAuth', { act: 0 })];
								case 21:
									_d.sent();
								...
								case 24:
									_d.sent();
									return [3, 27];
								case 25: return [4, this.$request('setSslVerify', { status: 0 })];
								case 26:
									rdata = _d.sent();
									rdata.status && this.$refreshBrowser();
									_d.label = 27;
					...
					$('#setImprovement').on('click',function() {
						var that = $(this),status =  $(this).prop('checked')
						bt.confirm({title:(!status?'关闭':'开启')+'用户体验改善计划', msg:status?'感谢您参与用户改善计划，帮助宝塔提升产品质量，使得我们有机会为您提供更优质的产品和服务，是否继续？':'非常感谢您对我们的支持，即将退出用户体验改善计划，是否继续？',cancel:function(){
								that.prop('checked',!status)
							}},function(){
							bt.send('set_improvement','config/set_improvement',{ status:Number(status)},function(rdata){
								bt.msg(rdata)
							})
						},function(){
							that.prop('checked',!status)
