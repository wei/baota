					...
					error: function (jqXHR, textStatus, errorThrown) {
						...
						if (jqXHR.status == 500 && jqXHR.responseText.indexOf('运行时发生错误') != -1) {
							if (jqXHR.responseText.indexOf('请先绑定宝塔帐号!') != -1) {
								if ($('.libLogin').length > 0 || $('.radio_account_view').length > 0)
									return false;
...
define("public/public", ["require", "exports", "snabbdom", "public/utils"], function (require, exports, snabbdom_2, utils_1) {
	...
	var Public = (function (_super) {
		...
		Public.prototype.renderLoginAlarmLine = function (config) {
			...
			var wx_account = message_channel_info.wx_account.data, email = message_channel_info.mail.data, feishu = message_channel_info.feishu.data, weixin = message_channel_info.weixin.data, dingding = message_channel_info.dingding.data;
			var isChannel = (!$.isEmptyObject(wx_account.res) && wx_account.res.is_bound == 1 && wx_account.res.is_subscribe == 1) ||
				!$.isEmptyObject(email) ||
